...
const BlogCard = ({ blog }: { blog: (typeof blogs)[0] }) => (
  ...
  >
    <div className="relative">
      ...
      />
      <span className="absolute top-3 left-3 bg-green-600 text-white text-xs px-3 py-1 pb-2 rounded-full shadow-md">
        {blog.category}
      </span>
    </div>
    <div className="p-5">
      <h2 className="text-md py-1 text-gray-800 hover:text-green-600 font-semibold mb-2 line-clamp-2">
        {blog.title}
      </h2>
